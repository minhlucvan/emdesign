...
### 5. Results panel as a Storybook addon panel tab
...
### 6. /mds:wand CLI command for scripted use

A new slash command `/mds:wand <component> [--vision]` that runs the auto-fix workflow on a named component without requiring preview selection. This exposes the wand for CI, batch, and non-visual workflows.
...
### 7. Vision critique is opt-in, not default
