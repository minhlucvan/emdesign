/**
 * @emdesign/workspace — the abstract workspace core: the opt-in installer (init/attach), the
 * framework registry, and the canonical `.claude/` template. Concrete stacks (e.g.
 * @emdesign/workspace-react) provide the Storybook scaffold + a server adapter.
 */
