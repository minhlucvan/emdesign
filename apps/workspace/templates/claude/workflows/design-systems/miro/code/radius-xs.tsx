...
export interface RadiusXsProps {
...
/**
 * `RadiusXs` — a 4px (xs) border radius demo square for the Miro radius scale.
 *
 * Renders an aspect-ratio square with the Miro 4px rounded corner token applied,
...
export const RadiusXs = ({
  ...
  style,
  ...rest
}: RadiusXsProps & React.HTMLAttributes<HTMLDivElement>) => {
  return (
    <div
      className={className}
      style={{
    ...
    >
      <span style={labelStyle}>
        4px
        <br />
        <span style={sublabelStyle}>xs</span>
      </span>
    </div>
  );
};

RadiusXs.displayName = 'RadiusXs';

export default RadiusXs;
